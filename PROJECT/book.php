...
<body>
    ...
    <div class="box">
        <section class="booking-form">
            <h2>Book a Room</h2>
            <form id="booking-form" onsubmit="return validateForm()" method="post" action="customers.php">
                ...
                <select id="roomtype" name="roomtype">
                    ...
                    <option value="superior">Superior Queen Room</option>
                    <option value="suite">Phewa Suite</option>
